...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ borderRadius: '10px', boxShadow: '0 4px 20px rgba(0,0,0,0.15)', display: 'flex', flexDirection: 'column', gap: '8px' }}
        className={`w-full max-w-xs shadow-2xl p-8 transition-all duration-500 ${darkMode
      ...
      >
        ...
        {step === 1 ? (
          ...
          <form className="space-y-2" onSubmit={handleVerifyAndRegister}>
            {/* OTP Input */}
            <div>
              <input
                type="text"
            ...
            <div>
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <VisibilityOffIcon style={{ fontSize: 20 }} className={darkMode ? "text-gray-400" : "text-gray-500"} />
                  ) : (
                    <VisibilityIcon style={{ fontSize: 20 }} className={darkMode ? "text-gray-400" : "text-gray-500"} />
                  )}
                </button>
              </div>
            </div>
